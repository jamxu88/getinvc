    ...
    render(){
        return(
            <form className='flex pt-8 place-self-center space-x-8 text text-2xl' onSubmit={this.handleSubmit}>
                <input type="text" value={this.state.lobbyId} placeholder='Enter Lobby Code' className='bg-brey rounded-lg p-4 text-white shadow-md italics' onChange={this.handleChange} maxLength="6">
                </input>
                <JoinLobby />
